...
import org.springframework.cloud.function.web.flux.RequestProcessor.FunctionWrapper;
...
public class FunctionController {
	...
	@ResponseBody
	public Mono<ResponseEntity<Publisher<?>>> form(WebRequest request) {
	...
	@PostMapping(path = "/**")
	@ResponseBody
	public Mono<ResponseEntity<Publisher<?>>> post(WebRequest request,
	...
	@GetMapping(path = "/**")
	@ResponseBody
	public Mono<ResponseEntity<Publisher<?>>> get(WebRequest request) {
		FunctionWrapper wrapper = wrapper(request);
